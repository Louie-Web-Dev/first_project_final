    ...
    <div class="Container">
        <div class="displayadd bg-transparent">
            ...
            <form method="get" style="margin: 20px 0; display: flex; gap: 10px; flex-wrap: wrap;">
                ...
                <input type="text" name="full_name" placeholder="Name" value="<?php echo htmlspecialchars($_GET['full_name'] ?? ''); ?>">
                ...
                <select name="toner_model">
                    ...
                    <?php
                    $toner_models = ["CF226X", "CC388X", "CF226X", "NPG90", "CEXVM", "CEXVC", "CEXVBK", "CEXVBC"];
                ...
                <a href="request_history.php" style="text-decoration: none;">
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    ...
                    if (!empty($full_name)) {
                        $where[] = "full_name = '" . mysqli_real_escape_string($conn, $full_name) . "'";
                    }
                    ...
                    $sql = "SELECT * FROM inventory_request $whereClause ORDER BY id DESC";
