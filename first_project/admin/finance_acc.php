...
<body>
    <div class="Container">
        <div class="displayadd bg-transparent">
            <h1>Finance and Accounting Toner Stock</h1>
        </div>
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    ...
                    $where = [];
                    $where[] = "inventory_in.department = 'Finance and Accounting'";
